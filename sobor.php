...
<?php
    ...
    ?>
           ...
           <div style="margin-left: 20px">
                <h1>Review and rating > Christ Church Cathedral (Dublin)</h1>
           </div>
           <div style="display: flex; justify-content: center;">
                <img src="images/sobor1.jpg" class="img-rounded" alt="Bebru ala" style="height: 60vh; width: 100vw">
           </div>
        </div>
                        ...
                        <div class="review-block">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="review-block-title">Good Church</div>
                                </div>
                            </div>
                            <hr />
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="review-block-title">A kur Exit??</div>
                                </div>
                            </div>
                            <hr />
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="review-block-title">Labs klosteris!</div>
                                </div>
                            </div>
                        </div>
                    </div>
