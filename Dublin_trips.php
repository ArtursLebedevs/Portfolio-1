...
<html lang="en">
  ...
  <body class="bg-light" style="margin:0">
    ...
    <?php
      ...
      ?>
      <!-First wide img->
       <img src="images/Dublin3.jpg" class="img-fluid" style="width: 100%; height: 60vh" alt="Photografer image"/>
       <div class="mb-5 mt-5">
                      ...
                      <div class="card-body">
                        ...
                        <div class="col-xl-3 border-start">        
                          <div class="d-flex flex-column mt-3">
                            <button class="btn btn-success btn-lg" type="button">Only 64$</button>
                          </div>
                        </div>
                      </div>
                    </div>
