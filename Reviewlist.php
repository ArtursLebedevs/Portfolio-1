...
<?php
    ...
    ?>
           ...
           <div style="margin-left: 20px">
                <h1>Review and rating > Bebru ala</h1>
           </div>
           <div style="display: flex; justify-content: center;">
                <img src="images/bebruala.jpg" class="img-rounded" alt="Bebru ala" style="height: 60vh; width: 100vw">
           </div>
        </div>
                        ...
                        <div class="review-block">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="review-block-title">Mājokļi gan neatrodas zem ūdens</div>
                                </div>
                            </div>
                            <hr />
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="review-block-title">A kur bebrs??</div>
                                </div>
                            </div>
                            <hr />
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="review-block-title">Ala super!</div>
                                </div>
                            </div>
                        </div>
                    </div>
