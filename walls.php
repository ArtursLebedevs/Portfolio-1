...
<?php
    ...
    ?>
           ...
           <div style="margin-left: 20px">
                <h1>Review and rating > Walls of Tallinn</h1>
           </div>
           <div style="display: flex; justify-content: center;">
                <img src="images/walls1.jpg" class="img-rounded" alt="Bebru ala" style="height: 60vh; width: 100vw">
           </div>
        </div>
                        ...
                        <div class="review-block">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="review-block-title">Man ir tadas sienas pagalma!</div>
                                </div>
                            </div>
                            <hr />
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="review-block-title">Aukstas sienas!</div>
                                </div>
                            </div>
                            <hr />
                            <div class="row">
