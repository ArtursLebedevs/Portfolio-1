...
<?php
    ...
    ?>
           ...
           <div style="margin-left: 20px">
                <h1>Review and rating > Reichstag building (Berlin)</h1>
           </div>
           <div style="display: flex; justify-content: center;">
                <img src="images/reih1.jpg" class="img-rounded" alt="Bebru ala" style="height: 60vh; width: 100vw">
           </div>
        </div>
                        ...
                        <div class="review-block">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="review-block-title">Dast ist Fantastich!!!</div>
                                </div>
                            </div>
                            <hr />
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="review-block-title">Kur blakus kafeinicas?</div>
                                </div>
                            </div>
                            <hr />
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="review-block-title">Laba vieta!</div>
                                </div>
                            </div>
                        </div>
                    </div>
