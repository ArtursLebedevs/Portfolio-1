...
<html lang="en">
  ...
  <body class="bg-light" style="margin:0">
    ...
    <?php
      ...
      ?>
      <!-First wide img->
       <img src="images/Rome3.jpg" class="img-fluid" style="width: 100%; height: 60vh" alt="Photografer image"/>
       <div class="mb-5 mt-5">
                      ...
                      <div class="card-body">
                        ...
                        <div class="col-xl-3 border-start">        
                          <div class="d-flex flex-column mt-3">
                            <button class="btn btn-success btn-lg" type="button">Only 80$</button>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div class="card shadow-0 border rounded-3">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-xl-3 border-start">        
                        <div class="d-flex flex-column mt-3">
                          <button class="btn btn-success btn-lg" type="button">Only 85$</button>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-md-6 col-lg-6 col-xl-6">
                        ...
                        <div class="col-xl-3 border-start">        
                          <div class="d-flex flex-column mt-3">
                            <button class="btn btn-success btn-lg" type="button">Only 90$</button>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="card shadow-0 border rounded-3">
                    <div class="card-body">
                      <div class="row">
                        ...
                        <div class="col-xl-3 border-start">        
                          <div class="d-flex flex-column mt-3">
                            <button class="btn btn-success btn-lg" type="button">Only 87$</button>
                          </div>
                        </div>
                      </div>
                    </div>
